...
public class LongShot : AbilityScript
{
    ...
    {
        CharacterMB hitCharacter = transform.GetComponent<CharacterMB>() ?? transform.GetComponentInParent<CharacterMB>();
    ...
    private void ApplyDamage(CharacterMB hitCharacter)
    {
